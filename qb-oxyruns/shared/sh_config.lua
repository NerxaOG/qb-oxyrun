...
Config.StartLocation = vector4(192.02, -1839.75, 28.07, 190.47) -- Start location for oxy run
Config.RunAmount = math.random(4, 8) -- How many drop-offs the player can make each run.
...
Config.CallCopsChance = 40 -- %Chance to alert police
